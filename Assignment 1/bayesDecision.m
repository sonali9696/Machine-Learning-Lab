...
for i = 1:50
    ...
    mean3 = mean3+img(3,round(x1(i)),round(y1(i)));
    mean4 = mean4+img(4,round(x1(i)),round(y1(i)));
    fprintf('%d %d %d %d\n',mean1,mean2,mean3,mean4);
end

mean1 = mean1*1.0/50.0;
mean2 = mean2*1.0/50.0;
mean3 = mean3*1.0/50.0;
mean4 = mean4*1.0/50.0;
...
for i = 1:100
    ...
    mean3 = mean3+img(3,round(x2(i)),round(y2(i)));
    mean4 = mean4+img(4,round(x2(i)),round(y2(i)));
end
...
for i=1:512
    for j=1:512
        test_data = [img(1,i,j);img(2,i,j);img(3,i,j);img(4,i,j)];
